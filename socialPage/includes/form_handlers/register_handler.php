...
if(isset($_POST['register_button'])){
    ...
    if($password != $password2) {
        ...
        if(preg_match('/[^A-Za-z0-9]/', $password)){
            array_push($error_array, "Your password can only have english character or numbers<br>");
        }
    }
 ...
 if(empty($error_array)){
     ...
     //Generate username by concatenating first name und last name
     ...
     if($rand = 1)
       $profile_pic = "assets/immages/profile_pics/defaults/head_deep_blue.png";
       else if($rand == 2)
